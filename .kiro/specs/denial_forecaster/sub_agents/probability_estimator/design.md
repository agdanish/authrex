# Design — `probability_estimator`

> Generated from Authrex `AGENT_MANIFEST` at 2026-05-02T13:05:55.335929+00:00.
...
## Input schema (`ProbabilityEstimatorInput`)
...
## Output schema (`ProbabilityEstimatorOutput`)
...
```json
{
  "properties": {
    "denial_probability": {
      "maximum": 1.0,
      "minimum": 0.0,
      "title": "Denial Probability",
      "type": "number"
    },
    "estimator_confidence": {
      "maximum": 1.0,
      "minimum": 0.0,
      "title": "Estimator Confidence",
      "type": "number"
    },
    "summary": {
      "description": "One sentence for coordinator dashboard.",
      "title": "Summary",
      "type": "string"
    }
  },
  ...
  "title": "ProbabilityEstimatorOutput",
  "type": "object"
}
```
...
1. Validate input against `ProbabilityEstimatorInput` (Pydantic).
...
6. Parse output into `ProbabilityEstimatorOutput` with retry-on-failure (Haiku→Sonnet escalation).
...
- `authrex_agent_invocations_total{agent="probability_estimator",status=...}`
