...
Thank you for considering contributing. Authrex is the kind of system where small misalignments become production incidents — every change should land here knowing why it landed.

## Read first

- [`README.md`](README.md) — what Authrex is and how to run it
...
- Cognizant alignment questions → [`ops/architecture/AI_VELOCITY_GAP_BUSINESS_CASE.md`](ops/industrialization/AI_VELOCITY_GAP_BUSINESS_CASE.md)
